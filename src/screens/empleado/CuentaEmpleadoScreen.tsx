    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.infoCard}>
        {[
          ...
          { label: 'Rol', valor: 'Empleado' },
          { label: 'Acceso', valor: 'Menú + Pedidos + Dashboard' },
          {
            label: 'Desde',
          ...
          <View key={i} style={[styles.infoRow, i === arr.length - 1 && { borderBottomWidth: 0 }]}>
            ...
            <Text style={styles.infoValor}>{row.valor}</Text>
          </View>
        ))}
      </View>
...
const styles = StyleSheet.create({
  ...
  avatar: {
    width: 90, height: 90, borderRadius: 45, backgroundColor: '#16213e',
    justifyContent: 'center', alignItems: 'center',
    borderWidth: 2, borderColor: '#26de81', marginBottom: 16,
  },
  ...
  empleadoBadgeText: { color: '#26de81', fontSize: 13, fontWeight: '700' },
  infoCard: {
